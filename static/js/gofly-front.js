...
GOFLY.init=function(config){
    ...
    if (typeof $!="function"){
        this.dynamicLoadJs("/static/jquery/3.6.0/jquery.min.js",function () {
            _this.dynamicLoadJs("/static/layer/3.4.0/layer.min.js",function () {
                _this.jsCallBack();
            });
        });
    }else{
        this.dynamicLoadJs("/static/layer/3.4.0/layer.min.js",function () {
            _this.jsCallBack();
        });
    }
